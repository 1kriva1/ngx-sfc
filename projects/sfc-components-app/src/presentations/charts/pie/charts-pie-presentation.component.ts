...
@Component({
  templateUrl: './charts-pie-presentation.component.html',
  styleUrls: ['../../../shared/styles/shared.component.scss'],
  styles: ['.component-column{ height: 15em; width: 30em;flex-direction: column;}']
})
export class ChartsPiePresentationComponent extends BaseChartTwoPresentationComponent {

  public override chartType: ChartType = 'pie';
