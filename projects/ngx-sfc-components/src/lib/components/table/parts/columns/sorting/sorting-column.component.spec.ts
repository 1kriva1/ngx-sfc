...
import { SortingColumnComponent } from './sorting-column.component';

describe('Component: SortingComponent', () => {
  let component: SortingColumnComponent;
  let fixture: ComponentFixture<SortingColumnComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [FontAwesomeModule],
      declarations: [SortingColumnComponent]
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(SortingColumnComponent);
