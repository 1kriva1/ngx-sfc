...
@Component({
  templateUrl: './bordered-select-common-presentation.component.html',
  styleUrls: ['../../../shared/styles/shared.component.scss']
})
export class BorderedCommonSelectPresentationComponent extends BaseSelectPresentationComponent
  implements OnInit {
